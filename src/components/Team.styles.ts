...
import { Box, Chip, Grid, Tab, Tabs, styled } from '@mui/material';
import { ProjectContent, ProjectPage } from './Project.styles';

export const TEAM_ORANGE = siteColors.accent;
...
export const TeamCards = styled(Grid)(({ theme }) => ({
  ...
  [theme.breakpoints.down('md')]: {
    gridTemplateColumns: 'minmax(0, 233px)',
...
export const ProfileRole = styled(Chip, {
  ...
  height: 25,
  borderRadius: 20,
  borderColor: isStudent ? theme.palette.common.white : TEAM_ORANGE,
